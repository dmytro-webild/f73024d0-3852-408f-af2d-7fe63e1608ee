...
24 primary button style variants available.
...
background: var(--color-primary-cta);
box-shadow: inset 0px 1px 0px 0px color-mix(in srgb, var(--color-foreground) 25%, transparent), inset 0px -1px 0px 0px color-mix(in srgb, var(--color-foreground) 25%, transparent);
...
background: var(--color-primary-cta);
box-shadow: inset 0px 1px 0px 0px var(--color-primary-cta), inset 0px -1px 0px 0px var(--color-primary-cta), inset 0px 2px 0px 0px color-mix(in srgb, var(--color-background) 25%, transparent), inset 0px -2px 0px 0px color-mix(in srgb, var(--color-background) 25%, transparent);
...
background: var(--color-primary-cta);
box-shadow: inset 0px 0px 0px 1px var(--color-primary-cta), inset 0px 0px 0px 2px color-mix(in srgb, var(--color-background) 25%, transparent);
...
background: var(--color-primary-cta);
box-shadow: color-mix(in srgb, var(--color-primary-cta) 13%, transparent) 0px 0.839802px 0.503881px -0.3125px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) 0px 1.99048px 1.19429px -0.625px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) 0px 3.63084px 2.1785px -0.9375px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) 0px 6.03627px 3.62176px -1.25px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) 0px 9.74808px 5.84885px -1.5625px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) 0px 15.9566px 9.57398px -1.875px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) 0px 27.4762px 16.4857px -2.1875px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) 0px 50px 30px -2.5px;
...
background: var(--color-primary-cta);
box-shadow: color-mix(in srgb, var(--color-background) 20%, transparent) 0px 3px 1px 0px inset, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) -1.26px 0.839802px 0.503881px -0.3125px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) -3px 1.99048px 1.19429px -0.625px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) -5.4px 3.63084px 2.1785px -0.9375px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) -9px 6.03627px 3.62176px -1.25px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) -14.6px 9.74808px 5.84885px -1.5625px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) -24px 15.9566px 9.57398px -1.875px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) -41px 27.4762px 16.4857px -2.1875px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) -75px 50px 30px -2.5px;

---

## primary-glow-flat-left

background: var(--color-primary-cta);
box-shadow: color-mix(in srgb, var(--color-primary-cta) 13%, transparent) -1.26px 0.839802px 0.503881px -0.3125px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) -3px 1.99048px 1.19429px -0.625px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) -5.4px 3.63084px 2.1785px -0.9375px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) -9px 6.03627px 3.62176px -1.25px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) -14.6px 9.74808px 5.84885px -1.5625px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) -24px 15.9566px 9.57398px -1.875px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) -41px 27.4762px 16.4857px -2.1875px, color-mix(in srgb, var(--color-primary-cta) 13%, transparent) -75px 50px 30px -2.5px;
...
background: var(--color-primary-cta);
box-shadow: 0 1px 2px color-mix(in srgb, var(--color-foreground) 10%, transparent), 0 3px 5px color-mix(in srgb, var(--color-primary-cta) 50%, transparent), inset 0 1px 0 0 color-mix(in srgb, var(--color-background) 25%, transparent);

---

## top-highlight

background: linear-gradient(180deg, color-mix(in srgb, var(--color-primary-cta) 80%, var(--color-background)) 0%, var(--color-primary-cta) 50%);
box-shadow: inset 0 1px 0 0 color-mix(in srgb, var(--color-background) 25%, transparent);
